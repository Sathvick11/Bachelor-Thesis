...
\begin{figure}[!h]
    %\centering
    \input{../Python/test}
    %\includegraphics[width=\textwidth]{Images/moo.png}
...
\begin{figure}[!h]
    ...
    %#! Why is this named as Arrhenius? PLEASE CHANGE IT!!!!
\end{figure}
...
\section{Current Problem} \label{current problem}
 ...
 %#! Exaplin the lack of standardization of module, difficulty in maintaining the modules effectively