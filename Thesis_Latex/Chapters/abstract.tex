...
%- (Optional) Keywords
\begin{abstract}
System developers at Bosch develop modules in MATLAB and Python to address specific use cases. These modules are integrated into Optislang, a software tool used 
